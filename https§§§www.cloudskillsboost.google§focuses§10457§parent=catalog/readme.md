...
> [https://www.cloudskillsboost.google/focuses/10457?parent=catalog](https://www.cloudskillsboost.google/focuses/10457?parent=catalog)


# Deploy to Kubernetes in Google Cloud: Challenge Lab

```bash
Docker_Image_and_Tag_Name="valkyrie-dev:v0.0.1"
REPOSITORY="valkyrie-docker"
PROJECT_ID="qwiklabs-gcp-00-a13fa7920bed"
...
docker tag 6ad6e30a0013 us-central1-docker.pkg.dev/$PROJECT_ID/$REPOSITORY/$Docker_Image_and_Tag_Name
